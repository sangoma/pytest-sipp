# -*- coding: utf-8 -*-
#
# pytest-sipp documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-sipp Documentation',
     [author], 1)
]
